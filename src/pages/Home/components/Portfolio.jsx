            ...
            <div className="row gy-4 isotope-container">
              <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                ...
                <div className="portfolio-info">
                  ...
                  <Link
                    to="assets/img/masonry-portfolio/masonry-portfolio-1.jpg"
                    title="App 1"
              ...
              <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                ...
                <div className="portfolio-info">
                  ...
                  <p>Lorem ipsum, dolor sit</p>
                  <Link
                    to="assets/img/masonry-portfolio/masonry-portfolio-2.jpg"
                    title="Product 1"
              ...
              <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                ...
                <div className="portfolio-info">
                  ...
                  <p>Lorem ipsum, dolor sit</p>
                  <Link
                    to="assets/img/masonry-portfolio/masonry-portfolio-3.jpg"
                    title="Branding 1"
              ...
              <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                ...
                <div className="portfolio-info">
                  ...
                  <p>Lorem ipsum, dolor sit</p>
                  <Link
                    to="assets/img/masonry-portfolio/masonry-portfolio-4.jpg"
                    title="App 2"
                    data-gallery="portfolio-gallery-app"
                    className="glightbox preview-link"
                  >
              ...
              <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                ...
                <div className="portfolio-info">
                  ...
                  <p>Lorem ipsum, dolor sit</p>
                  <Link
                    to="assets/img/masonry-portfolio/masonry-portfolio-5.jpg"
                    title="Product 2"
                    data-gallery="portfolio-gallery-product"
                    className="glightbox preview-link"
                  >
